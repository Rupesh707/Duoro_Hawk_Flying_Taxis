...
data = {
    1: np.loadtxt('/Users/rupesh/Desktop/Check/Duoro_Hawk/data/MackeyGlass_t17.txt'),  # MSE = 1.00835041454e-06)
}[v]
print ("done")

f = pd.read_csv("/Users/rupesh/Desktop/Check/Duoro_Hawk/data/MackeyGlass_t17.txt", header=None)
min = f.min()
max = f.max()
