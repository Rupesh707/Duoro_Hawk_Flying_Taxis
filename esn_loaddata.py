...
def load_data(ntrips_train, ntrips_test, washout_fraction=0):
    ...
    """
    print ("loading data..."),
    data_train = pd.read_csv('/Users/rupesh/Desktop/Check/Duoro_Hawk/data/train_df.csv', nrows=ntrips_train,
   ...
   # create the training trips image
    #plot_trips(data_train, ntrips_train, "taxi_train_trips_image.png")
    ...
    data_test = pd.read_csv('/Users/rupesh/Desktop/Check/Duoro_Hawk/data/train_df.csv',
    ...
    #plot_trips(data_train, ntrips_train, "taxi_test_image.png")
